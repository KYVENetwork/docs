      ...
      <div className="border-wrap rounded-xl w-full">
        <div className="w-full rounded-xl root-background">
          <div className="flex flex-col dark:bg-black dark:bg-opacity-20 p-4 w-full rounded-xl">
            ...
            >
              <div className="flex w-full border border-black border-opacity-50 dark:border-borderColor border-solid p-2 mt-2 rounded-full">
                <input
                ...
                />
                <button
                  className="ml-auto btn-primary font-bold w-24 rounded-full text-white"
                  type="submit"
