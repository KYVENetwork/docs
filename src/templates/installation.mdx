...
:::caution
Like for all Web3 projects, we always recommend using your own endpoints for optimal security and the independence of centralized architecture. This implies running your own KYVE chain node, you can find more information [here](/run-a-node/chain-nodes/join-network).
:::
