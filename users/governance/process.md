...
Deposit amounts are at risk of being burned. Prior to a governance proposal entering the voting period (ie. for the proposal to be voted upon), there must be at least a minimum number of KYVE deposited (20.000/100.000 for expedited proposal). Anyone may contribute to this deposit. Deposits of passed and failed proposals are returned to the contributors.

In the past, different people have considered contributions amounts differently. There is some consensus that this should be a personal choice. There is also some consensus that this can be an opportunity for supporters to signal their support by adding to the deposit amount, so a proposer may choose to leave contribution room (ie. a deposit below 20.000 KYVE) so that others may participate. It is important to remember that any contributed KYVE are at risk of being burned.

### Burned deposits

Deposits are burned when proposals:

1. **Expire** - deposits will be burned if the deposit period ends before reaching the minimum deposit (20.000 KYVE)
2. **Are vetoed** - deposits for proposals with 33.4% of voting power backing the `NoWithVeto` option are also burned

## Voting Period

The voting period is currently a fixed 1-day (30-minutes for expedited proposals) period. During the voting period, participants may select a vote of either `Yes`, `No`, `Abstain`, or `NoWithVeto`. Voters may change their vote at any time before the voting period ends.
...
1. A minimum deposit of 20.000 KYVE is required for the proposal to enter the voting period
   - anyone may contribute to this deposit
   - the deposit must be reached within 5 minutes (this is the deposit period)
...
Voting power is determined by stake weight at the end of the 1-day voting period and is proportional to the number of total KYVE participating in the vote. Only bonded KYVE count towards the voting power for a governance proposal. Liquid KYVE will not count toward a vote or quorum.
