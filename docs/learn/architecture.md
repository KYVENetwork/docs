...
:::tip
A more detailed overview and guides on how to run those nodes can be found [here](/validators)
:::
...
:::tip
You can find all the info about how the KYVE protocol works in detail [here](/learn/protocol_structure/overview)
:::
