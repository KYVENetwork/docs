...
community pool. You can find more information on the calculation of the uploader reward [here](/docs/learn/protocol-structure/advanced-concepts/uploader-reward-calculation.md).
...
[here](/docs/learn/protocol-structure/advanced-concepts/uploader-reward-calculation.md) and more details about the delegation distribution [here](/docs/learn/protocol-structure/advanced-concepts/delegation-reward-calculation.md).
