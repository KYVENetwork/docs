...
to bootstrap your KYVE node. For this the node-syncing tool [KSYNC](/docs/validators/ksync/overview.md) can be used. To install
...
For this the node-syncing tool [KSYNC](/docs/validators/ksync/overview.md) can be used. To install
KSYNC run the following:
