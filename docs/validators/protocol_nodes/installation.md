...
If you loose this config file or a third party gets hold of this data the worst case could be that an upload slash or a timeout slash can be caused.

## Install pool binaries

Get the pool binaries and move them to the correct folder
